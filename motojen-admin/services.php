...
?>
    ...
    <div class="container">
        ...
        <main id="admin_table">
           ...
           <div class="btn-add">
            <a href="add-services.php" class="btn1"><i class="material-icons-sharp">add_circle</i> Add Services</a>
            </div>
           ...
           <table>
            ...
            $countQuery = "SELECT COUNT(*) AS count FROM tbl_services";
            ...
            $sql = "SELECT * FROM tbl_services LIMIT $startFrom, $recordsPerPage";
            ...
            if ($totalRecords > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="update-services.php?id=<?php echo $id;?>" class="btn"><i class="material-icons-sharp">edit</i> Update</a>

                                <form action="code.php" method="POST">
                                    <button type="button" class="btn-del delete_servicebtn" value="<?= $id;?>"><i class="material-icons-sharp">delete</i> Delete</button>
                                </form>
                            </div>
                        </td>
                    </tr>
