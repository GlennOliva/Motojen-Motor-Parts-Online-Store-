    ...
    <div class="container">
        ...
        <aside>
            ...
            <a href="dashboard.php">
                ...
                <a href="serviceappoint.php" class="active">
                    <span class="material-icons-sharp">
                        shopping_cart
                    </span>
            ...
            <td class="tbl-30">
                <div class="btn-group1">
                    <?php if (!$disableUpdateBtn) { // Check if the button should be enabled ?>
                        <a href="update-serviceappoint.php?id=<?php echo $id; ?>" class="btn"><i class="material-icons-sharp">edit</i> Update</a>
                    <?php } else { ?>
